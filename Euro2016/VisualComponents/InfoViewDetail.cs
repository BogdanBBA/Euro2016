...
namespace Euro2016.VisualComponents
{
    public class InfoViewDetail : MyEuroBaseControl
    {
        ...
        public InfoViewDetail()
            : base()
        {
            this.description = new Tuple<Font, Brush, string>(StaticData.PVC != null ? new Font(StaticData.PVC.Families[StaticData.FontExoLight_Index], 11, FontStyle.Regular) : new Font("Arial", 11, FontStyle.Bold),
                MyGUIs.Text.Normal.Brush, "#description");
            this.text = new Tuple<Font, Brush, string>(StaticData.PVC != null ? new Font(StaticData.PVC.Families[StaticData.FontExoBold_Index], 12, FontStyle.Bold) : new Font("Arial", 13, FontStyle.Bold),
                MyGUIs.Text.Normal.Brush, "#text");
